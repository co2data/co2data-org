...
describe('combine source links', () => {
  it('happy path', () => {
    ...
    expect(actual).toMatchInlineSnapshot(`
      [
        {
          "description": "the carbon intensity of beef from the specialized beef herds is almost nfourfold that produced from the dairy herd (67.8 vs. 18.4 kg CO2-eq per kg carcass weight). nn[fao.org](https://www.fao.org/3/i3461e/i3461e03.pdf)",
          "gCo2e": 18400,
          "id": "2b914117-d5e2-11ed-9416-de741d4b6ce8",
          "links": {
            "_id": "Option",

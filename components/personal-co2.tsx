    ...
    <div className="max-w-sm overflow-hidden rounded-lg border border-sky-600 bg-sky-50 p-8">
      ...
      <div className="">
        ...
        <div className="tooltip-container text-center">
          ...
          <br />
          of the <b>total</b> CO<sub>2</sub>e Footprint of 1{' '}
          <svg
            viewBox="0 -2 20 55"
          ...
          &ensp;
          <a href="#" role="button" aria-label="More information">
            &#9432;
          </a>
        ...
        <div className="mt-8 block touch-pan-y">
          ...
          <input
            ...
            step={
              (co2Average.times_per_year_to - co2Average.times_per_year_from) /
              50
            }
            value={times}
